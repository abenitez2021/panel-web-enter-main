...
export default function ListaPermanenciaDia() {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text('PERMANENCIAS ACTUALES ', 60, 10); // Ajusta las coordenadas y el tamaño de fuente
    ...
    const fileName = `PERMANENCIAS_${dateTime}.pdf`;
        ...
        <>
          <Grid container spacing={2} >
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              <List >
                  <ListItem >
                      <ListItemText primary="PERMANENCIAS DE HOY" secondary="Visualizá el detalle de todos las visitantes que permanecen el dia de hoy" />
                  </ListItem>
              </List>
