...
export default function ListaPersonasVisitantes() {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text('PERSONAS REGISTRADAS', 60, 10); // Ajusta las coordenadas y el tamaño de fuente
    ...
    doc.save('PERSONAS-REGISTRADAS.pdf');
  };
        ...
        <>
          <Grid container spacing={2} >
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              <List >
                  <ListItem >
                      <ListItemText primary="PERSONAS - VISITANTES" secondary="Visualizá la lista de personas que han realizado su visita" />
                  </ListItem>
              </List>
